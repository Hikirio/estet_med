...
<body>
  <body>
    ...
    <div class="page">
      <!-- Page content-->
      <section class="section-404-ie context-dark bg-size" style="background-image: url({{asset('/images/bg-image-404-1920x1080.jpg')}});">
        <div class="section-single-inner">
            ...
            <div class="container">
              <div class="row row-30">
                <div class="col-sm-6 text-center">
                  <p class="text-extra-large text-white">404</p>
                </div>
                <div class="col-sm-6 justify-content-center">
                  <div class="section-single-main-content">
                    <h5 class="title-decorated title-decorated-lg text-uppercase text-white"> Page was not found</h5>
                    <p><span class="text-width-2 text-white">You may have mistyped the address or the page may have moved.</span></p><a class="button button-lg button-primary button-winona text" href="{{url('/')}}">Back to home page</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="footer-minimal section-single-footer">
            <div class="container">
              <div class="footer-minimal-inner text-center justify-content-center"><a class="brand" href="{{url('/index')}}"><img src="/images/logo-light-119x44.png" alt="" width="119" height="44" srcset="/images/logo-light-119x44.png 2x"/></a>
