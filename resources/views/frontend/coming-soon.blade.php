...
<head>
  ...
  <body>
    ...
    <div class="page">
      <!-- Page content-->
      <section class="section section-single bg-size context-dark" style="background-image: url({{asset('/images/bg-image-coming-soon-1920x1080.jpg')}});">
        <div class="section-single-inner">
            ...
            <div class="container">
              <div class="row row-30 justify-content-center justify-content-sm-start">
                <div class="col-sm-10 col-md-9 col-lg-7 col-xl-6">
                  <h5 class="title-decorated title-decorated-lg text-uppercase text-font-sec text-white">We're getting ready to launch in</h5>
                  <!-- TimeCircles-->
                  <div class="countdown-wrap">
                    <div class="DateCountdown" data-type="until" data-date="2019-12-31 00:00:00" data-format="wdhms" data-color="#6f43d6" data-bg="rgba(245, 245, 245, 1)" data-width="0.02"></div>
                  </div>
                  <p class="text-left text-white">Our website is under construction, we are working very hard to give you the best experience on our new web site.</p>
                  <div class="rd-mailform-wrap">
                    <!-- RD Mailform-->
                    <form class="rd-form rd-mailform form-inline" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="../../../public/bat/rd-mailform.php">
                      ...
                      <div class="form-button offset-top-20-sm-0-2">
          ...
          <div class="footer-minimal section-single-footer">
            <div class="container">
              <div class="footer-minimal-inner"><a class="brand" href="index.blade.php"><img src="/images/logo-light-119x44.png" alt="" width="119" height="44" srcset="../../../public/images/logo-light-119x44.png 2x"/></a>
