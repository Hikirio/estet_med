...
<section class="section-xl context-dark bg-image-2" style="background-image: url({{asset('/images/bg-about-01-1700x376.jpg')}})">
        <div class="container">
          <div class="row justify-content-center text-center">
            <div class="col-lg-12">
              <h2 class="text-uppercase text-center">Typography</h2>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-10 col-xl-8">
              ...
              <figure class="figure-light offset-top-30"><img class="img-centered" src="/images/typography-770x480.jpg" alt="" width="770" height="480"/>
                <figcaption>
