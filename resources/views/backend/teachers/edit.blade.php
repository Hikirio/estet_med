					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
								<!--begin::Form-->
								<form action="{{route('teachers.update', $teacher->id)}}" method="post" id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/products.html">
                                    @csrf
                                    @method('patch')
									<!--begin::Aside column-->
													...
													<div class="card card-flush py-4">
														...
														<div class="card-body pt-0">
															...
															<div class="mb-10 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" name="name" class="form-control mb-2" placeholder="teacher's name" value="{{ $teacher->name }}" />
																<!--end::Input-->
																<!--begin::Description-->
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="lastname" class="form-control mb-2" placeholder="teacher's lastname" value="{{ $teacher->lastname }}" />
                                                                <!--end::Input-->
                                                                <!--begin::Description-->
                                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>
                                                                <!--end::Description-->
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="surname" class="form-control mb-2" placeholder="teacher's surname" value="{{ $teacher->surname }}" />
                                                                <!--end::Input-->
                                                                <!--begin::Description-->
                                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>
                                                                <!--end::Description-->
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="specialize" class="form-control mb-2" placeholder="teacher's spesialize" value="{{ $teacher->specialize }}" />
                                                                <!--end::Input-->
                                                                <!--begin::Description-->
                                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>
                                                                <!--end::Description-->
...
{{--															</div>--}}
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="description" class="form-control mb-2" placeholder="teacher's description" value="{{ $teacher->description }}" />
                                                                <!--end::Input-->
                                                                <!--begin::Description-->
                                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>
                                                                <!--end::Description-->
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="visible" class="form-control mb-2" placeholder="enter visible" value="{{$teacher->visible}}" />
                                                                <!--end::Input-->
                                                                <!--begin::Description-->
                                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>
                                                                <!--end::Description-->
