...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
																...
																<div class="menu-sub menu-sub-accordion">
																	...
																	<div class="menu-item">
																		<a class="menu-link py-3" href="{{url('add-order')}}">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																			<span class="menu-title">Add Order</span>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
											...
											<thead>
												...
												<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="text-end min-w-70px">surname</th>
													<th class="text-end min-w-100px">specialize</th>
													<th class="text-end min-w-100px">description</th>
													<th class="text-end min-w-100px">photo</th>
													<th class="text-end min-w-100px">visible</th>
											...
											<tbody class="fw-bold text-gray-600">
												...
												<tr>
													...
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">{{$teacher->id}}</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="{{route('teachers.show', $teacher->id)}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder">{{$teacher->name}}</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<td class="text-end pe-0" data-order="Completed">
														<!--begin::Badges-->
														<div class="badge badge-light-success">{{$teacher->surname}}</div>
														<!--end::Badges-->
													</td>
													<!--end::Status=-->
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">{{$teacher->specialize}}</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-03-23">
														<span class="fw-bolder">{{$teacher->description}}</span>
													</td>
													<!--end::Date Added=-->
													<!--begin::Date Modified=-->
													<td class="text-end" data-order="2022-03-29">
														<span class="fw-bolder">{{$teacher->photo}}</span>
													</td>
													<!--end::Date Modified=-->
													<!--begin::Action=-->
													<td class="text-end">
														<p href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">{{$teacher->visible}}
														<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
                                                    <td class="text-end">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                            ...
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3" >
                                                                <a href="{{route('teachers.edit', $teacher->id)}}"  class="menu-link px-3"> Edit </a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
        ...
        <script src="{{asset('/plugins/datatables/datatables.bundle.css')}}"></script>
        <!--end::Page Vendors Javascript-->
        <!--begin::Page Custom Javascript(used by this page)-->
        <script src="{{asset('/js/custom/apps/ecommerce/sales/listing.js')}}"></script>
